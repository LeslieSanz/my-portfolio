    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'videogame' ?
            <ToggleButton active value="videogame" onClick={() => setToggle('videogame')}>VIDEOGAMES</ToggleButton>
            :
            <ToggleButton value="videogame" onClick={() => setToggle('videogame')}>VIDEOGAMES</ToggleButton>
          }
        </ToggleButtonGroup>
        <CardContainer>
          {toggle === 'all' && projects
